...
class Api{
   ...
   Future<dynamic> get({required String url,@required String? token})async{
    ...
    if(response.statusCode==200){
      ...
      throw Exception('there is a problem of statescode ${response.statusCode}');
    }
  }
  Future<dynamic> post({required String url,@required dynamic body,@required String? token})async{
     ...
     return data;
       ...
       {
         throw Exception('error in statusCode ${response.statusCode} with body ${jsonDecode(response.body)}');
       }
  }
